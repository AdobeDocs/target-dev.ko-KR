...
* 단일 코드 행과 일회용 개발자 설정을 통해 마케터는 SPA에서 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)를 통해 [!UICONTROL A/B 테스트] 및 [!UICONTROL 경험 타깃팅]&#x200B;(XT) 활동을 만들고 실행할 수 있습니다.

## XDM 보기 및 단일 페이지 애플리케이션

SPA용 [!UICONTROL Adobe Target] VEC는 SPA 경험을 함께 구성하는 시각적 요소의 논리 그룹인 [!UICONTROL 보기]라는 개념을 사용합니다. 따라서 단일 페이지 애플리케이션은 사용자 상호 작용을 기반으로 URL 대신 보기를 통해 전환으로 간주할 수 있습니다. [!UICONTROL 보기]는 일반적으로 전체 사이트나 사이트 내의 그룹화된 시각적 요소를 나타낼 수 있습니다.

&quot;보기&quot;가 무엇인지 더 설명하기 위해 다음 예제에서는 [!DNL React]에 구현된 가상의 온라인 전자 상거래 사이트를 사용하여 [!UICONTROL 보기] 예제를 살펴봅니다.

홈 사이트로 이동한 후 영웅 이미지는 사이트에서 사용할 수 있는 최신 제품과 부활절 판매를 홍보합니다. 이 경우 전체 홈 화면에 대해 [!UICONTROL 보기]를 정의할 수 있습니다. 이 [!UICONTROL 보기]를 &quot;홈&quot;이라고 할 수 있습니다.

![브라우저 창에서 단일 페이지 응용 프로그램의 샘플 이미지입니다.](/help/dev/implement/client-side/aep-web-sdk/assets/example-views.png)

고객이 비즈니스에서 판매하는 제품에 관심이 많아짐에 따라 **제품** 링크를 클릭하기로 합니다. 홈 사이트와 마찬가지로 제품 사이트 전체를 [!UICONTROL 보기]&#x200B;(으)로 정의할 수 있습니다. 이 [!UICONTROL 보기]의 이름을 &quot;products-all&quot;로 지정할 수 있습니다.

![모든 제품이 표시된 브라우저 창의 단일 페이지 응용 프로그램의 샘플 이미지입니다.](/help/dev/implement/client-side/aep-web-sdk/assets/example-products-all.png)

[!UICONTROL 보기]는 전체 사이트나 사이트의 시각적 요소 그룹으로 정의할 수 있으므로 제품 사이트에 표시된 4개의 제품을 그룹화하여 [!UICONTROL 보기]&#x200B;(으)로 간주할 수 있습니다. 이 보기의 이름은 &quot;products&quot;로 지정할 수 있습니다.

![브라우저 창에 있는 단일 페이지 응용 프로그램의 샘플 이미지입니다(예: 제품 표시).](/help/dev/implement/client-side/aep-web-sdk/assets/example-products.png)

고객이 사이트에서 더 많은 제품을 탐색하기 위해 **추가 로드** 단추를 클릭하기로 결정해도 웹 사이트 URL은 변경되지 않습니다. 그러나 표시되는 두 번째 제품 행만 나타내는 [!UICONTROL 보기]을(를) 여기에 만들 수 있습니다. [!UICONTROL 보기] 이름은 &quot;products-page-2&quot;일 수 있습니다.
...
고객은 사이트에서 몇 가지 제품을 구매하기로 하고 체크아웃 화면으로 진행합니다. 체크아웃 사이트에서는 고객에게 일반 배달 또는 빠른 배달을 선택할 수 있는 옵션이 제공됩니다. [!UICONTROL 보기]는 사이트의 모든 시각적 요소 그룹일 수 있으므로 게재 환경 설정에 대해 [!UICONTROL 보기]을(를) 만들고 &quot;게재 환경 설정&quot;이라고 할 수 있습니다.

![브라우저 창의 단일 페이지 응용 프로그램 체크 아웃 페이지에 대한 샘플 이미지입니다.](/help/dev/implement/client-side/aep-web-sdk/assets/example-check-out.png)

[!UICONTROL 보기]의 개념을 이 시나리오보다 훨씬 더 확장할 수 있습니다. 이러한 시나리오는 사이트에서 정의할 수 있는 [!UICONTROL 보기]의 몇 가지 예입니다.
...
>[!NOTE]
>
>첫 번째 `sendEvent()` 호출에서 최종 사용자에게 렌더링해야 하는 모든 [!UICONTROL XDM 보기]를 가져오고 캐시합니다. 전달된 [!UICONTROL XDM 보기]가 있는 후속 `sendEvent()` 호출은 캐시에서 읽히고 서버 호출 없이 렌더링됩니다.
...
선택한 게재 환경 설정에 따라 사이트에서 콘텐츠를 개인화하려면 각 게재 환경 설정에 대해 [!UICONTROL 보기]를 만들 수 있습니다. **일반 배달**&#x200B;을 선택하면 [!UICONTROL 보기]의 이름을 &quot;checkout-normal&quot;로 지정할 수 있습니다. **빠른 배달**&#x200B;을 선택한 경우 [!UICONTROL 보기]의 이름을 &quot;checkout-express&quot;로 지정할 수 있습니다.
...
## SPA에 [!UICONTROL 시각적 경험 작성기] 사용

[!UICONTROL XDM 보기]를 정의하고 전달된 [!UICONTROL XDM 보기]로 `sendEvent()`을(를) 구현한 경우 VEC는 이러한 [!UICONTROL 보기]를 감지하고 사용자가 A/B 또는 XT 활동에 대한 작업 및 수정 사항을 만드는 것을 허용할 수 있습니다.
...
[!UICONTROL 수정 사항] 패널은 특정 [!UICONTROL 보기]에 대해 만들어진 작업을 캡처합니다. [!UICONTROL 보기]에 대한 모든 작업은 해당 [!UICONTROL 보기] 아래에 그룹화됩니다.

### 액션

작업을 클릭하면 이 작업이 적용되는 사이트의 요소가 강조 표시됩니다. [!UICONTROL 보기]에서 만든 각 VEC 작업에는 **정보**, **편집**, **복제**, **이동** 및 **삭제** 아이콘이 있습니다. 이러한 아이콘은 다음 표에 자세히 설명되어 있습니다.

| 아이콘 | 설명 |
|---|---|
| 정보 | 작업의 세부 사항을 표시합니다. |
| 편집 | 작업의 속성을 직접 편집할 수 있습니다. |
| 복제 | 작업을 [!UICONTROL 수정] 패널에 있는 하나 이상의 [!UICONTROL 보기] 또는 VEC에서 탐색하고 이동한 하나 이상의 [!UICONTROL 보기]에 복제합니다. 작업이 반드시 [!UICONTROL 수정] 패널에 있지 않아도 됩니다.<br/><br/>**참고:** 복제 작업이 수행된 후에는 [!UICONTROL 찾아보기]를 통해 VEC의 [!UICONTROL 보기]로 이동하여 복제된 작업이 올바른 작업인지 확인해야 합니다. 작업을 [!UICONTROL 보기]에 적용할 수 없으면 오류가 표시됩니다. |
| 이동 | 작업을 [!UICONTROL 페이지 로드 이벤트] 또는 [!UICONTROL 수정] 패널에 이미 있는 다른 [!UICONTROL 보기]&#x200B;(으)로 이동합니다.<br/><br/>**페이지 로드 이벤트:** 페이지 로드 이벤트에 해당하는 모든 작업은 웹 응용 프로그램의 초기 페이지 로드 시 적용됩니다. <br/><br/>**참고:** 이동 작업이 수행된 후에는 [!UICONTROL 찾아보기]를 통해 VEC의 [!UICONTROL 보기]로 이동하여 이동이 올바른 작업인지 확인해야 합니다. 작업을 [!UICONTROL 보기]에 적용할 수 없는 경우 오류를 확인하십시오. |
| 삭제 | 작업을 삭제합니다. |

## SPA용 VEC 사용 예

이 섹션에서는 [!UICONTROL 시각적 경험 작성기]를 사용하여 A/B 또는 XT 활동에 대한 작업 및 수정 사항을 만드는 세 가지 예를 간략하게 설명합니다.

### 예제 1: &quot;home&quot; 보기 업데이트

이 문서의 앞부분에서 &quot;home&quot;이라는 [!UICONTROL 보기]가 전체 홈 사이트에 대해 정의되었습니다. 이제 마케팅 팀은 다음과 같은 방법으로 &quot;홈&quot; 보기를 업데이트하려고 합니다.
...
&quot;products-page-2&quot; [!UICONTROL 보기]의 경우 마케팅 팀에서 **가격** 레이블을 **판매 가격**(으)로 변경하고 레이블 색상을 빨간색으로 변경하려고 합니다.
...
[!UICONTROL 보기]은(는) 라디오 단추의 상태 또는 옵션과 같이 세분화된 수준에서 정의할 수 있습니다. 이 문서의 앞부분에서 [!UICONTROL 보기]는 배달 환경 설정 &quot;checkout-normal&quot; 및 &quot;checkout-express&quot;에 대해 정의되었습니다. 마케팅 팀이 &quot;checkout-express&quot; 보기에 대해 단추 색상을 빨간색으로 변경하려고 합니다.
...
>[!NOTE]
>
>**빠른 배달** 라디오 단추를 선택할 때까지 &quot;checkout-express&quot; [!UICONTROL 보기]가 [!UICONTROL 수정] 패널에 표시되지 않습니다. **빠른 배달** 라디오 단추가 선택되어 있으면 `sendEvent()` 함수가 실행되므로 라디오 단추가 선택될 때까지 VEC가 &quot;checkout-express&quot; [!UICONTROL 보기]를 인식하지 못하기 때문입니다.
