...
| [[!UICONTROL adobe.target.applyOffers(options)]](/help/dev/implement/client-side/atjs/atjs-functions/adobe-target-applyoffers-atjs-2.md)<P>(at.js 2.x) | 이 함수를 사용하면 [!UICONTROL adobe.target.getOffers()]로 검색된 오퍼를 두 개 이상 적용할 수 있습니다.<P>**참고:** 이 함수는 at.js 2.x에서 도입되었습니다. 이 함수는 at.js 버전 1.*x*&#x200B;에서 사용할 수 없습니다. |
