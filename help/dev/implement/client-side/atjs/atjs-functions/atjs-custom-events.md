...
description: mbox 요청 또는 오퍼가 실패하거나 성공하면 알림을 받으려면  [!DNL Adobe Target] at.js JavaScript 라이브러리에 대한 사용자 지정 이벤트를 사용하십시오.
