...
| 단계 | 설명 |
| --- | --- |
| 1 | Experience Cloud 방문자 ID가 [Adobe Experience Cloud ID 서비스](https://experienceleague.adobe.com/docs/id-service/using/home.html?lang=ko&)에서 검색되었습니다. |
