...
>[!WARNING]
>
>[!UICONTROL on-device decisioning]을(를) 사용하도록 [!DNL Adobe Target] SDK을 초기화하기 전에 토글을 사용하도록 설정해야 합니다. 규칙 아티팩트는 먼저 [!UICONTROL on-device decisioning]이(가) 작동하도록 Akamai CDN을 생성하고 전파해야 합니다. 전파는 첫 번째 규칙 아티팩트가 생성되어 Akamai CDN으로 전파하는 데 5~10분 정도 걸릴 수 있습니다.
