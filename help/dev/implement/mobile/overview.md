...
모바일 앱에서 [!DNL Target]을(를) 구현하는 방법에 대한 자세한 내용은 [모바일 앱용 Adobe Experience Platform SDK](https://developer.adobe.com/client-sdks/documentation/){target=_blank} 설명서를 참조하십시오. [!DNL Target]에 대한 정보는 [Adobe Target](https://developer.adobe.com/client-sdks/documentation/adobe-target/){target=_blank}에서 찾을 수 있습니다.
