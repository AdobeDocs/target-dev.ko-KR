...
서버 측 통합의 한 가지 이점은 병렬 처리를 사용하여 서버 측에서 사용할 수 있는 엄청난 대역폭과 컴퓨팅 리소스를 활용할 수 있다는 것입니다. [!DNL Target] Java SDK은 비동기 요청을 지원하므로 유효 타겟 시간을 0으로 줄일 수 있습니다.
...
이 예제에서는 Spring Bean으로 [SDK 초기화](initialize-sdk.md)를 했으며 [유틸리티 메서드](utility-methods.md)를 사용할 수 있다고 가정합니다.
