---
title: 요청을 기록하려면  [!DNL Adobe Target] Node.js SDK을 초기화하십시오
...
[SDK을 초기화](initialize-sdk.md)할 때 `options.logger` 개체는 선택 개체입니다. 그러나 문제가 발생할 때 효과적으로 디버깅하려면 SDK을 초기화할 때 `logger` 개체를 제공해야 합니다.
