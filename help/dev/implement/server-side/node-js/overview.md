...
description: ' [!DNL Adobe Target] 고객이 Node.js SDK을 설치, 초기화 및 사용하는 방법을 알아봅니다.'
feature: APIs/SDKs
...
이 참조 안내서에서는 [!DNL Adobe Target] 고객이 Node.js SDK을 설치, 초기화 및 사용하는 방법을 보여 줍니다.
...
Node.js SDK을 사용하여 시작하는 방법을 보려면 [Target SDK 시작 안내서](../sdk-guides/getting-started/getting-started.md)로 이동하십시오.

## 샘플 앱

Node.js SDK 테스트 드라이브:
