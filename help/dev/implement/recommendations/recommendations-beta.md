---
keywords: 권장 사항, 설정, 환경 설정, 업계 카테고리, 호환되지 않는 기준 필터링, 기본 호스트 그룹, 썸네일 기본 url, 권장 사항 api 토큰,
...
장바구니 기반 권장 사항에 대한 자세한 내용은 [&#x200B; 비즈니스 실무자 안내서](https://experienceleague.adobe.com/en/docs/target/using/recommendations/criteria/base-the-recommendation-on-a-recommendation-key#cart-based)의 *[!DNL Adobe Target]장바구니 기반*&#x200B;을(를) 참조하십시오.
...
방문자에게 추천하지 않으려는 글로벌 수준의 항목을 제외합니다. [&#x200B; 비즈니스 실무자 안내서](https://experienceleague.adobe.com/en/docs/target/using/recommendations/entities/exclusions)의 *[!DNL Adobe Target]제외*&#x200B;를 참조하십시오.

## &#x200B;5. [!UICONTROL Recommendations] 설정 구성

설정을 사용하여 [!UICONTROL Recommendations] 구현을 관리하십시오.

**[!UICONTROL Recommendations Settings]** 옵션에 액세스하려면 [!DNL Target]에서 [!DNL Adobe Experience Cloud]을(를) 연 다음 **[!UICONTROL Administration]** > **[!UICONTROL Recommendations]**&#x200B;을(를) 클릭합니다.

![권장 사항 설정 페이지](/help/dev/implement/recommendations/assets/recs-settings-new.png)
...
[!DNL Adobe Target] API를 포함한 [!DNL Recommendations Admin] 관리 API는 인증된 사용자만 [!DNL Adobe Target]에 액세스하는 데 사용하도록 인증을 통해 보호됩니다. [Adobe Developer Console](https://developer.adobe.com/console/home)을(를) 사용하여 [!DNL Adobe Experience Cloud solutions]을(를) 포함한 모든 [!DNL Adobe Target]에 대해 이 인증을 관리하세요.
...
자세한 내용은 [Adobe Target 비즈니스 실무자 안내서](https://experienceleague.adobe.com/en/docs/target/using/recommendations/criteria/algorithms){target=_blank}의 *기준*&#x200B;을 참조하십시오.
...
이 옵션에 대한 자세한 내용은 [[!UICONTROL Recommendations] 비즈니스 실무자 안내서](https://experienceleague.adobe.com/en/docs/target/using/recommendations/recommendations-faq/recommendations-faq){target=_blank}의 *[!DNL Adobe Target]FAQ*&#x200B;를 참조하십시오.
...
자세한 내용은 [&#x200B; 비즈니스 실무자 안내서](https://experienceleague.adobe.com/en/docs/target/using/administer/hosts){target=_blank}의 *[!DNL Adobe Target]호스트*&#x200B;를 참조하십시오.
