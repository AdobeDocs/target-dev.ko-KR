...
1. **[!UICONTROL 프로필 API]**&#x200B;에서 **[!UICONTROL 인증 필요]** 전환을 사용 또는 사용 안 함 위치로 전환합니다.

   ![대체 이미지](assets/profile_api_settings.png)

1. (조건부) 인증 요구 사항을 사용하도록 설정한 경우 **[!UICONTROL 새 프로필 인증 토큰 생성]**&#x200B;을 클릭합니다.
...
1. 필요에 따라 토큰을 다시 생성하려면 **[!UICONTROL 새 프로필 인증 토큰 생성]**&#x200B;을 클릭하십시오.
