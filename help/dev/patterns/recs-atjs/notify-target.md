...
* 전환 이벤트와 함께 보낼 수 있도록 데이터 레이어에서 다음 속성을 사용할 수 있는지 확인합니다. 전환 이벤트는 제품 구매 또는 장바구니에 추가 이벤트와 같은 매출을 생성합니다.
  ...
  다음 그림은 [&#x200B; 페이지에서만 실행해야 하는  [!DNL tags] 규칙  [!DNL Experience Platform]in](https://experienceleague.adobe.com/docs/tags.html?lang=ko){target=_blank}[!UICONTROL Confirmation]을(를) 보여 줍니다.
